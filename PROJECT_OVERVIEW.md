...
- 在线链接转码入口 PRD：`/devplan/ONLINE_MEDIA_TRANSCODE_PRD.md`
- 在线链接转码入口开发任务拆解：`/devplan/ONLINE_MEDIA_TRANSCODE_DEV_TASKS.md`
- yt-dlp Android 源码编译接入方案：`/devplan/YTDLP_ANDROID_INTEGRATION.md`
...
- `player:core`：`/player/core/MODULE.md`
